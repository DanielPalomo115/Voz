                    ...
                    if (result.get(0).equals("siguiente")) {
                        ...
                        if (result.get(0).equals("anterior")) {
                            ...
                            if (result.get(0).equals("información")) {
                                Uri uri = Uri.parse("http://marte.org.sv/");
                                Intent in1 = new Intent(Intent.ACTION_VIEW, uri);
                                startActivity(in1);
                            } else {
                                if
                                        (result.get(1).equals("información")) {
                                    Uri uri = Uri.parse("http://marte.org.sv/");
                                    Intent in1 = new Intent(Intent.ACTION_VIEW, uri);
                                    startActivity(in1);
                                } else {
                                    if (result.get(2).equals("información")) {
                                        Uri uri = Uri.parse("http://marte.org.sv/");
                                        Intent in1 = new Intent(Intent.ACTION_VIEW, uri);
                                        startActivity(in1);
                                    } else {
                                        if (result.get(3).equals("información")) {
                                            Uri uri = Uri.parse("http://marte.org.sv/");
                                            Intent in1 = new Intent(Intent.ACTION_VIEW, uri);
                                            startActivity(in1);
                                        } else {
                                            if (result.get(4).equals("información")) {
                                                Uri uri = Uri.parse("http://marte.org.sv/");
                                                Intent in1 = new Intent(Intent.ACTION_VIEW, uri);
                                                startActivity(in1);
                                            } else {
                                                if (result.get(5).equals("información")) {
                                                    Uri uri = Uri.parse("http://marte.org.sv/");
                                                    Intent in1 = new Intent(Intent.ACTION_VIEW, uri);
                                                    startActivity(in1);
                                                }
